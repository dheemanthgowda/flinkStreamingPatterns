package com.learning.flinkstreaming.StreamingPattern;
...
public class StreamingAnalytics {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            DataStream<Tuple3<String, String, Double>> productWindowedSummary = salesOrderObject
                    ...
                    .process(new ProcessWindowFunction<Tuple2<String, Double>, Tuple3<String, String, Double>, String, TimeWindow>() {
